...
import band.mlgb.picalchemy.utils.bitmapToByteBuffer
import band.mlgb.picalchemy.utils.bitmapToUri
import band.mlgb.picalchemy.utils.convertArrayToBitmap
import band.mlgb.picalchemy.utils.errBGLM
import band.mlgb.picalchemy.utils.getInterpreter
...
class StyleTransferer @Inject constructor(
    ...
    private val interpreterPredict: Interpreter = getInterpreter(context, STYLE_PREDICT_FP16_MODEL)
    private val interpreterTransform: Interpreter =
        getInterpreter(context, STYLE_TRANSFER_FP16_MODEL)
